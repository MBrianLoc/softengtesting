      ...
      render() {
        ...
        return (
            ...
            <div>
                <label>NetID:</label>
                <div>
                    <input type="text" ref="username" placeholder="enter NetID" onChange={this.handleIdChange}></input>
                </div>
            ...
            <div>
                ...
                <div>
                    <input type="password" ref="password" placeholder="enter password" onChange={this.handlePassChange}></input>
                </div>
            </div>
